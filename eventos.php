    ...
    <div id="header-slider" class="carousel slide carousel-fade" data-ride="carousel">        
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active"> <!-- Slider Item #1 -->
                 <img src="images/eventos_header.jpg" alt="..." class="img-responsive">               
            </div>
...
<div class="arriba row">
            <div class="abajo col-lg-12">
                <h4 class="color_titulo">EVENTOS Y FECHAS RELEVANTES</h4>                
            </div>
  </div>
 ...
 <div class="row">
          ...
          <div class="arriba col-md-3 col-sm-3 col-xs-12">
                 <div class="row">
          
                    <div>
                        <img src="images/eventos_1.png" alt="Tea Maker" class="img-responsive img-center" />                        
                    </div>
                  </div>


                      <div class="abajo2 col-md-3 col-sm-3 col-xs-12">
                     </div>

     
                   <div class="row"> 
                      <div>
                        <img src="images/eventos2.png" alt="Tea Maker" class="img-responsive img-center" />                        
                      </div>
                    </div>
