            ...
            <div class="row">
                <div class="col-md-2 col-xs-5">
                    <a href="#home" title="Logo" class="logo scroll">
                            <img src="../images/logos/LogoFeseVerde.webp"  class="logo-dark" alt="Logo FESE">   <!--logo color oscuro-->
                            <img src="../images/logos/LogoFeseBlanco.webp" alt="Logo FESE" class="logo-light default"> <!--logo color claro-->
                    </a>
                </div>
                <!-- end logo -->
                <div class="col-md-7 col-xs-2 width-auto pull-right accordion-menu xs-no-padding-right hidden-sm hidden-xs">
                    <div class="navbar-collapse collapse pull-right" id="navbar-collapse-toggle-1">
                        <ul id="accordion" class="nav navbar-nav navbar-left no-margin alt-font text-normal"
                            ...
                            <li>
                                <a href="#about" class="scroll">Que hacemos</a>
                            </li>-->
                            <!--<li>
                ...
                <div class="col-md-2 col-xs-5 width-auto sm-width-15 xs-width-20 no-padding">
                    <div class="header-social-icon sm-display-none" aria-hidden="true">
                        <a href="https://www.facebook.com/FESE.MX" class="facebook-bg-hvr" title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        <a href="https://twitter.com/fese_mx" class="twitter-bg-hvr" title="Twitter"><i class="fa fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/company/fundacion-educacion-superior-empresa/" class="linkedin-bg-hvr" title="Linkedin"><i class="fa fa-linkedin"></i></a>
                        <!--<a href="https://www.youtube.com/user/FeseMexico." class="youtube-bg-hvr"><i class="fa fa-youtube"></i></a>-->
                    </div>
                </div>
                <!--side nav -->
                ...
                <div class="sidebar_menu">
                    <nav class="pushmenu pushmenu-right">
                        <a class="push-logo" href="#."><img src="../images/logos/LogoFeseBlanco.webp" alt="logo FESE"></a>
                        <div class="medium-icon side-nav-social-icon list-inline">
                            <a class="facebook-bg-hvr" href="https://www.facebook.com/FESE.MX" title="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a class="twitter-bg-hvr" href="https://twitter.com/fese_mx" title="Twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                            <a class="linkedin-bg-hvr" href="https://www.linkedin.com/company/fundacion-educacion-superior-empresa/" title="Linkedin"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        </div>
                        <ul class="push_nav centered">
                            <li class="clearfix">
                                <a href="../index.html" class="scroll">Inicio</a>
                        ...
                        <p class="push-bottom text-white text-small">FESE "Fundacion Educacion Superior Empresa"</p>
                    </nav>
                </div>
...
<section id="home" class="no-padding no-transition">
    <h1 class="display-none" aria-hidden="true">FESE</h1>
    <h2 class="display-none" aria-hidden="true">FESE</h2>
    <div id="rev_slider_5_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="boltex-4"
        ...
        <div id="rev_slider_5_1" class="rev_slider fullscreenbanner carruselempresarial " style="display:none;" data-version="5.4.5">  <!--aqui hacemos la referencia de la imagen de bienvenida, la cual se encuentra en la hoja de estilo en enlace a esta imagen-->
            <ul>    <!-- SLIDE  -->
                <li data-index="rs-11" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    <!-- MAIN IMAGE -->
                    <!-- <img src="images/index/BeneficiosEmpresas.webp" alt="Beneficios empresarial" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina> -->
                    <!-- LAYERS -->   <!--Agrege esta imagen que seria la de empresarial-->
                   ...
                   <!--<div class="tp-caption   tp-resizeme rs-parallaxlevel-7"
                         ...
                         style="z-index: 5;"><img src="images/1513f-transparent-square.png" alt="image"
                                                  ...
                                                  data-hh="['612px','612px','445px','333px']" data-no-retina>
                      </div>-->
...
s
                        ...
                        <div  class="col-sm-5 ">APROVECHA LOS BENEFICIOS <br>QUE TENEMOS PARA TU EMPRESA</div>
                    </div>-->

                    <!-- LAYER NR. 3 -->

                    
                    <div class= "col-lg-9 text-center center-col last-paragraph-no-margin centrar" >
                      <div class="split-box text-center ">
                          <div  class="centra">                              
                              <h3  class = "text-white margin-30px-top" >                                
                                APROVECHA LOS BENEFICIOS QUE TENEMOS PARA TU EMPRESA  <!--Aqui podemos agregar un texto arriba del titulo, este texno va sin la etiqueta <p>-->
                              </h3>
                              <div class=" margin-30px-top font-weight-100  text-white">
                                Programa que <strong>vincula estudiantes y recién egresados</strong> de las instituciones de Educación Superior
								(IES) con empresas. Para la realización de <strong> practicas, estancias y/o residencias profesionales.</strong>
                    ...
                    <!-- LAYER NR. 4 -->
                    <!--<div class="tp-caption   tp-resizeme rs-parallaxlevel-2 text-center"
                         id="slide-11-layer-4"
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
...
<section id="features" class="position-relative">
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 margin-30px-bottom">
                <div class="services-item text-center">
                    <i class="fa fa-trophy" aria-hidden="true"></i>
                    <h6 class="text-extra-dark-gray margin-10px-tb alt-font font-weight-400">11</h6>
                    <hr class="services-hr">
                    <p>Años vinculando talentos.</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 margin-30px-bottom">
                <div class="services-item text-center">
                    <i class="fa fa-graduation-cap" aria-hidden="true"></i>
                    <h6 class="text-extra-dark-gray margin-10px-tb alt-font font-weight-400">9,500</h6>
                    <hr class="services-hr">
                    <p>Estudiantes que han obtenido sus estancias profesionales.</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 margin-30px-bottom">
                <div class="services-item text-center">
                    <i class="fa fa-university" aria-hidden="true"></i>
                    <h6 class="text-extra-dark-gray margin-10px-tb alt-font font-weight-400">+200</h6>
                    <hr class="services-hr">
                    <p>Instituciones educativas colaboran con nosotros.</p>
                </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12 margin-30px-bottom">
                <div class="services-item text-center">
                    <i class="fa fa-building" aria-hidden="true"></i>
                    <h6 class="text-extra-dark-gray margin-10px-tb alt-font font-weight-400">367</h6>
                    <hr class="services-hr">
                    <p>Empresas que se han vinculado exitosamente.</p>
                </div>
            </div>
            <!--<div class="col-md-4 col-sm-6 col-xs-12 margin-30px-bottom">
                <div class="services-item text-center">
                    <i class="fa fa-book" aria-hidden="true"></i>
                    <h6 class="text-extra-dark-gray margin-10px-tb alt-font font-weight-400">Barnding</h6>
                    <hr class="services-hr">
            ...
            <div class="row">
                <div class="col-md-6 no-padding">
                    <div class="about-image hover-effect">
                        <img alt="Fondo empresarial" src="../images/empresarial/MexicoDigital.webp" class="equalheight">  <!--AQUI ES LA PRIMERA PARTE DE "QUE HACEMOS"--------->
                    </div>
                </div>
                <div class="col-md-6 sm-padding-50px-tb">
                    <div class="split-box text-center center-block equalheight">
                        <div class="about-box">
                            <div class="text-large text-red margin-10px-bottom font-weight-400 text-blue">
                                <!--Aqui podemos agregar un texto arriba del titulo, este texno va sin la etiqueta <p>-->
                            </div>
                            <div class="col-md-12"><br>
                                <h3 class="color_titulo"> ¿Buscando talento universitario para su empresa?  </h3>
                            </div>
                            <div  class="col-md-12 text-center">
                            <br><br>
                                <p class="text-justify">
                                <!--<img class="imgFlotanteDer" src="assets/img/edificio.png" alt="fondoprogramas"  />  -->                  
                                    Somos una asociación civil respaldada por instituciones de educación superior,
                                    dedicada a conectar a jóvenes universitarios de todo el país con oportunidades de experiencia laboral;
                                    tenemos una amplia base de datos de estudiantes altamente capacitados y motivados que están listos 
                                    para aplicar sus habilidades y conocimientos en su empresa.
                                </p>                 
                            </div>
                        </div>                       
                    </div>
...
<section>
    ...
    <div class="col-md-12 text-left" >
        <br> 
            <h3 class="color_titulo">Nuestro proceso es simple: </h3><br>
        </div>                        
        <div class="col-md-12 text-left">
            <ul class="sangriaLista">
                <li class="sangriaLista">Trabajamos con usted para entender sus necesidades de talento universitario.</li><br> 
                <li class="sangriaLista">Presentamos a los estudiantes adecuados para su consideración y selección.</li><br>
                <li class="sangriaLista">Ingreso y gestión de prácticas, estadías y/o estancias profesionales.</li><br>
            </ul>
            <p>Además, nuestro equipo de expertos brinda apoyo y asesoramiento a los estudiantes durante el 
            proceso de inserción para garantizar una transición suave y exitosa a su equipo.</p>
        </div>
        <div class="col-md-12"><br><br><br><br>
            <h4 class="color_titulo">Si está interesado en conocer más sobre este servicio no dude en ponerte en contacto con nosotros. </h4>
        </div>
        <div class="col-md-12 text-left">
            ...
            <div class="col-sm-1">
                <a href="mailto:empresarial@fese.org.mx" class="btn btn-transparent-blue btn-rounded btn-large margin-20px-top">Contactanos</a>
            </div>
            <br>
...
<!--<section class="no-padding">
    <h2 class="display-none no-padding no-margin" aria-hidden="true">FinzHHHHHHHHHHHHHHHa</h2>
    <div class="row">
            ...
            <div class="row clearfix">-->
                ...
                <!--<div class="col-md-6">
                    ...
                    <!--<div class="row margin-15px-bottom">
                        ...
                        <div class="col-sm-11">
                            <p class="text-small">
                              Fundación Educación Superior-Empresa A.C.<br>
                              Tenayuca 200, Santa Cruz Atoyac,<br>
                              Benito Juárez, 03310, CDMX.<br>
                    ...
                    <!--<div class="row margin-15px-bottom">
                        ...
                        <div class="col-sm-11 xs-margin-50px-bottom">
                            <p class="text-small">contacto@fese.mx</p>
                        </div>
                    </div>
                </div>-->
                <!------------------------------------------------------------------------------------------------------------------------->
...
<!--footer Start-->
<footer id="contact" class="FondoVerdeFese padding-30px-tb ">  <!--la clase de color negro es:bg-extra-dark-gray -->
    <div class="footer-widget-area">
        <div class="container">
            <div class="row">
            <!--------------------------------------------------------------------------------------->
                <div class="col-sm-2">
                <img src="../images/logos/LogoESR.webp" class="equalheight" alt="Empresa socialmente responsable"/> <!--Se cambio el nombre y se agrego un metadato-->
                </div>
            <!--------------------------------------------------------------------------------------->
            <!--<div class="row margin-5px-bottom">-->
                <div class="col-sm-1 no-padding" >
                    <div class="contact-icon text-white">
                        <i class="fa fa-map-marker" aria-hidden="true"  text-center></i>
                    </div>
                </div>
                <div class="col-sm-4">
                   <p class="text-small  text-white">
                        Fundación Educación Superior-Empresa A.C.<br>
                        Tenayuca 200, Santa Cruz Atoyac,<br>
                        Benito Juárez, 03310, CDMX.
                    </p>
                </div>
                <!--------------------------------------------------------------------------------------->
                <div class="col-sm-1 no-padding text-left"  >
                    <div class="contact-icon text-white">
                        <i class="fa fa-phone" aria-hidden="true"></i>
                    </div>
                </div>
                <div class="col-sm-2">
                    <p class="text-small  text-white  text-left" >
                        55-5605-6100<br>
                    </p>
                </div>
                <!--------------------------------------------------------------------------------------->
                ...
                <div class="col-sm-12 text-center" >
                    <br>
                    <a href="../avisodeprivacidad.html" class="btn btn-transparent-white btn-rounded btn-large margin-20px-top">AVISO DE PRIVACIDAD</a>
